...
public class Item extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2483673883901312577L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Item\",\"namespace\":\"model.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"float\"}]}");
   ...
   */
  public Item(java.lang.Long id, java.lang.CharSequence name, java.lang.Float price) {
    this.id = id;
    this.name = name;
    this.price = price;
  }
   ...
   */
  public static model.avro.Item.Builder newBuilder() {
    return new model.avro.Item.Builder();
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static model.avro.Item.Builder newBuilder(model.avro.Item.Builder other) {
    return new model.avro.Item.Builder(other);
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static model.avro.Item.Builder newBuilder(model.avro.Item other) {
    return new model.avro.Item.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Item>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(model.avro.Item.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(model.avro.Item other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.avro.Item.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.avro.Item.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.avro.Item.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.avro.Item.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public model.avro.Item.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public model.avro.Item.Builder clearPrice() {
